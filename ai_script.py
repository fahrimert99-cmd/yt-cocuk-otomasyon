...
PROMPT = """Sen Veritasium tarzında bilim içeriği üreten bir YouTube yazarıısın.
BAŞLIK: {baslik}
Bu başlık için genel izleyiciye uygun, akıcı, bilimsel olarak DOĞRU bir Türkçe seslendirme metni yaz. ~110 kelime. Metin yüksek sesle okunacaktır: kısa ve doğal cümleler kur; konuşma dilinde olmayan devrik veya aşırı uzun cümlelerden, gereksiz noktalama işaretlerinden ve arka arkaya yabancı terimlerden kaçın. Kısaltmaları mümkünse Türkçe karşılığıyla yaz (örneğin "yapay zekâ", "vayfay"); yabancı kelimeler için Türkçe karşılığı tercih et: "illusion/ilizyon" yazma, "yanılsama" yaz. Yabancı özel adları yalnızca gerçekten gerekliyse kullan. İLK CÜMLE ÇOK ÖNEMLİ: kurulumla/tanımla BAŞLAMA; doğrudan ŞOK EDİCİ sonucu/twist'i ver ki izleyici ilk 2 saniyede kaymasın (örn. "Kurulum..." değil "Aslında sen kandırılıyorsun..." gibi vurucu açılış). Sonda düşündürücü bir kapanış. Uydurma istatistik/sayı verme. Emoji/başlık/madde YOK, düz paragraf. Anlatımı 10 kısa ve birbirinden farklı sahneye böl; her sahne için İNGİLİZCE sinematik bir görsel tarifi yaz. Aynı nesneyi farklı sahnelerde tekrar etme; her sahne farklı kadraj ve görsel bilgi taşısın.
