...
# ai_script.py'daki dusuk-seviye cagiricilari (Gemini + Pollinations yedek) yeniden kullanir.
import os, json, time
...
(4) MUTLAKA sonda somut "nasil korunursun" adimlari. Sonda dusundurucu guclu bir kapanis + kisa abone cagrisi.
